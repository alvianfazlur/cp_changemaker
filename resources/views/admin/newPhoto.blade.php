            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div id="Donations" class="tab-pane">
                        <form action="/admin/store-photo" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{-- <input type="hidden" name="id" value=""> <br/> --}}
                            <div class="wpo-donations-amount">
                                <h2>Title</h2>
                                <textarea class="form-control" name="title" id="description" required></textarea>
                                <br>
                                <h2>Caption</h2>
                                <textarea class="form-control" name="caption" id="description" required></textarea>
                                <br>

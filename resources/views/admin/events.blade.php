  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-white active bg-gradient-primary" href="/admin/events">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">table_view</i>
              </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Events Database</h6>
              </div>
              <br>
                <a class="btn btn-outline-success" href="../admin/new-event">Add New Event</a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Event_date</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{substr($e->event_name, 0, 20)}}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{ Carbon::parse($e->event_date)->format('d F Y') }}</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{ substr($e->location, 0, 50) }}</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{substr($e->description, 0, 50)}}</p>
                      </td>
                      <td class="align-middle">
                        <a href="/admin/edit-events/{{$e->id}}" class="text-secondary font-weight-bold text-xs btn" data-toggle="tooltip" data-original-title="Edit user" data-id="{{$e->id}}">
                            EDIT
                        </a>
                      </td>                    
                      <td class="align-middle">
                        <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs btn" data-toggle="tooltip" data-original-title="Edit user" data-id="{{$e->id}}" onclick="confirmDelete({{$e->id}})">
                            Delete
                        </a>
                      </td>                       
                    </tr>

                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="/admin/update-recruitment/{{$r->id}}" class="text-secondary font-weight-bold text-xs btn-warning" data-toggle="tooltip" data-original-title="Edit user" data-id="{{$r->id}}">
                            EDIT
                        </a>
                      </td>                    
                    </tr>

                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @php
                          $description = substr($r->decription, 0, 50);
                          $requirements = substr($r->requirements, 0, 50);
                          $benefits = substr($r->benefits, 0, 50);
                        @endphp
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{!! $benefits !!}</p>
                      </td>
                      <td>

...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Gallery</h6>
          </nav>
          </div>
        </div>
      </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Gallery Database</h6>
              </div>
              <br>
                <a class="btn btn-outline-success" href="../admin/new-photo">Add New Photo</a>
            </div>
                                    ...
                                    <div class="wpo-campaign-single">
                                        <div class="wpo-campaign-item">
                                            <div class="wpo-campaign-img">
                                                <img src="../file_gallery/{{$g->image}}" alt="">
                                            </div>
                                            <div class="wpo-campaign-content">
                                                <div class="wpo-campaign-text-top">
                                                    ...
                                                    <div class="campaign-btn">
                                                        <ul>
                                                            <li><a class="e-btn" href="/admin/update-photo/{{$g->id}}">Edit Caption</a></li>
                                                            
                                                            <li><a href="javascript:void(0);" class="e-btn" data-toggle="tooltip" data-original-title="Edit user" data-id="{{$g->id}}" onclick="confirmDelete({{$g->id}})">
                                                                Delete
                                                            </a></li>
                                                        </ul>
                                                    </div>
  ...
  <script>
    function confirmDelete(id) {
        ...
        if (result) {
            window.location.href = "/admin/delete-photo/" + id;
        }
    }
  </script>
</body>
